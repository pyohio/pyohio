...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TalkProposal.reviewer'
        db.add_column(u'proposals_talkproposal', 'reviewer',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'TutorialProposal.reviewer'
        db.add_column(u'proposals_tutorialproposal', 'reviewer',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TalkProposal.reviewer'
        db.delete_column(u'proposals_talkproposal', 'reviewer')

        # Deleting field 'TutorialProposal.reviewer'
        db.delete_column(u'proposals_tutorialproposal', 'reviewer')
